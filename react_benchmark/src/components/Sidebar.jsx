        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href="#" class="nav-link d-flex" aria-current="page">
              ...
              <h2 class="my-auto">Home</h2>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link d-flex">
              <i class="fas fa-search text-center"></i>
              <h2 class="my-auto">Search</h2>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link d-flex">
              <i class="fas fa-book text-center"></i>
              <h2 class="my-auto">Your Library</h2>
            </a>
          </li>
        </ul>
        <button
          type="button"
          class="btn rounded-pill btn-sign-up"
          onclick="window.location.href = '/login-page/login.html'"
        >
          SIGN UP
        </button>
        <button
          type="button"
          class="btn rounded-pill btn-log-in"
          onclick="window.location.href = '/login-page/login.html'"
        >
          LOGIN
        </button>
        <div class="mx-auto d-flex flex-column nav-text-block">
          <p class="nav-text-bottom m-0">Cookie | Privacy</p>
          <p class="nav-text-bottom"> Policy </p>
        </div>
      </div>
    </>
  );
